<template>
  <modal
    :visible="dialogVisibleConsMap"
    customClass="Miniform"
    @on-closed="dialogVisibleConsMapClosed"
  >
    <template slot="head">
      <span>选择定位</span>
    </template>
    <template slot="body">
      <div class="map-body">
        <div class="map-keyword">
          <el-input v-model="searchKey" id="search"></el-input>
    ...
    <template slot="foot">
      <el-button @click="dialogVisibleConsMapClosed">取消</el-button>
      <el-button type="primary" @click="submitConsArea">确定</el-button>
    </template>
  </modal>
</template>
...
export default {
  name: "AddMapConsModal",
  components: {
    modal,
  },
  props: {
    dialogVisibleConsMap: {
      type: Boolean,
    },
    searchKey: {
      type: String,
